...
export default function StoryPage() {
  return (
    // Lock height to screen to prevent scrolling
    <main className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-neutral-950">
      ...
      <div
        className="relative z-20 flex flex-col items-center text-center px-8 py-10 md:px-16 md:py-14 
                      bg-black/50 backdrop-blur-lg border border-white/10 rounded-sm 
                      max-w-[92%] md:max-w-2xl shadow-2xl"
      >
        ...
        <p className="max-w-md text-[11px] md:text-[12px] font-light tracking-[0.3em] text-white/70 uppercase leading-relaxed">
          Crafting genuine hostel hospitality <br />
          in the vibrant heart of Ekkamai district.
        </p>
